...
export default async function ExpensesPrintPage({ searchParams }: { searchParams: Promise<Search> }) {
  ...
  let entries = await getExpenses({ start, end, category });
  ...
  return (
    <div className="print-invoice">
      <AutoPrint />
      <div className="invoice-title">Expenses Report</div>
