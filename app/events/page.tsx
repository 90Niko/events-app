        ...
        <header className="mb-6">
          ...
          <form className="mt-4 grid grid-cols-1 gap-3 rounded-2xl border border-slate-200 bg-white/70 p-3 shadow-sm backdrop-blur md:grid-cols-4" method="get">
            ...
            <div className="flex items-end gap-2">
              ...
              <a href="/events" className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm text-slate-700 shadow-sm hover:bg-slate-50">Clear</a>
            </div>
          </form>
        </header>
                ...
                {events.map((e: any) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-slate-700">{e.owner ?? "-"}</td>
                      <td className="px-4 py-3 text-slate-700">{whenStr}</td>
                      <td className="px-4 py-3 text-slate-700">{e.city ?? "-"}</td>
                      <td className="px-4 py-3 text-slate-700">{deadline ? format(deadline, "yyyy-MM-dd") : "-"}</td>
