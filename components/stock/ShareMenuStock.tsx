        ...
        <div className="w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-4 shadow-xl" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="mt-3 grid grid-cols-1 gap-2">
            <button type="button" className="btn-outline justify-start" onClick={copyLink}>
              <svg aria-hidden viewBox="0 0 24 24" className="h-4 w-4"><path fill="currentColor" d="M3 16a5 5 0 005 5h3v-2H8a3 3 0 110-6h3v-2H8a5 5 0 00-5 5zm8-7V7H8a3 3 0 000 6h3v-2H8a1 1 0 110-2h3zm3-2h-3v 2h3a1 1 0 010 2h-3v2h3a3 3 0 000-6z"/></svg>
